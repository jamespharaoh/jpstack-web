...
@PrototypeComponent ("imChatPurchaseStartApiAction")
public
class ImChatPurchaseStartApiAction
	...
	Optional <WebResponder> handle (
		...
		try (
			...
			Optional <WebResponder> createPurchaseResult =
				createPurchase (
					transaction);
	...
	Optional <WebResponder> createPurchase (
			@NonNull Transaction parentTransaction) {
	...
	Optional <WebResponder> createResponse (
			@NonNull Transaction parentTransaction) {

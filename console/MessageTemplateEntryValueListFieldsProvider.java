...
@HiddenComponent
public
class MessageTemplateEntryValueListFieldsProvider
	...
	Provider <MessageTemplateEntryValueFieldsProvider>
		messageTemplateEntryValueFieldsProviderProvider;
	...
	MessageTemplateEntryValueFieldsProvider makeComponent (
		...
		try (
			...
			return messageTemplateEntryValueFieldsProviderProvider.get ()
